...
<div class="form-group">
<input class="form-control" type="tel" name="phone" placeholder="Your Contact" data-parsley-required="true" data-parsley-type="contact" data-parsley-error-message="Enter a Valid Contact">
</div>
